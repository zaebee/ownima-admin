...
export const SystemPage: React.FC = () => {
  ...
  const systemMetrics = systemInfo ? [
    ...
    {
      title: 'Environment',
      value: systemInfo.environment.charAt(0).toUpperCase() + systemInfo.environment.slice(1),
      icon: GlobeAltIcon,
    ...
    },
    {
      ...
      value: systemInfo.database_status.charAt(0).toUpperCase() + systemInfo.database_status.slice(1),
      icon: CircleStackIcon,
      description: 'Database connection status',
      color: getStatusColor(systemInfo.database_status),
    },
    {
      title: 'API Status',
      ...
      color: getStatusColor(systemInfo.api_status),
    },
    {
      title: 'System Uptime',
