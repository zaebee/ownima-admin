...
describe('Toast', () => {
  ...
  describe('Basic Rendering', () => {
    it('renders with title', () => {
      render(<Toast id="test-1" type="info" title="Test Toast" onClose={vi.fn()} duration={0} />);
  ...
  describe('Toast Types', () => {
    it('renders success toast with correct styling', () => {
      const { container } = render(
        <Toast id="test-1" type="success" title="Success!" onClose={vi.fn()} duration={0} />
      );
    ...
    it('renders error toast with correct styling', () => {
      const { container } = render(
        <Toast id="test-1" type="error" title="Error!" onClose={vi.fn()} duration={0} />
      );
    ...
    it('renders warning toast with correct styling', () => {
      const { container } = render(
        <Toast id="test-1" type="warning" title="Warning!" onClose={vi.fn()} duration={0} />
      );
    ...
    it('renders info toast with correct styling', () => {
      const { container } = render(
        <Toast id="test-1" type="info" title="Info" onClose={vi.fn()} duration={0} />
      );
  ...
  describe('Close Button', () => {
    ...
    it('calls onClose when close button is clicked', () => {
      ...
      render(
        <Toast id="test-1" type="info" title="Test Toast" onClose={handleClose} duration={0} />
      );
  ...
  describe('Auto Dismiss', () => {
    it('auto dismisses after default duration (5000ms)', () => {
      ...
      render(<Toast id="test-1" type="info" title="Test Toast" onClose={handleClose} />);
    ...
    it('auto dismisses after custom duration', () => {
      ...
      render(
        <Toast id="test-1" type="info" title="Test Toast" onClose={handleClose} duration={3000} />
      );
    ...
    it('does not auto dismiss when duration is negative', () => {
      ...
      render(
        <Toast id="test-1" type="info" title="Test Toast" onClose={handleClose} duration={-1} />
      );
  ...
  describe('Animation', () => {
    it('has transition classes for animation', () => {
      const { container } = render(
        <Toast id="test-1" type="info" title="Test Toast" onClose={vi.fn()} duration={0} />
      );
  ...
  describe('Edge Cases', () => {
    it('handles very long titles', () => {
      ...
      render(<Toast id="test-1" type="info" title={longTitle} onClose={vi.fn()} duration={0} />);
    ...
    it('handles empty string message', () => {
      render(
        <Toast id="test-1" type="info" title="Title" message="" onClose={vi.fn()} duration={0} />
      );
...
describe('ToastContainer', () => {
  ...
  describe('Multiple Toasts', () => {
    ...
    it('handles toast removal', () => {
      ...
      const { rerender } = render(<ToastContainer toasts={initialToasts} onClose={vi.fn()} />);

      expect(screen.getByText('Success 1')).toBeInTheDocument();
      expect(screen.getByText('Error 1')).toBeInTheDocument();

      // Remove one toast
      const updatedToasts = [{ id: '2', type: 'error' as const, title: 'Error 1' }];
    ...
    it('handles toast addition', () => {
      const initialToasts = [{ id: '1', type: 'success' as const, title: 'Success 1' }];
  ...
  describe('Positioning', () => {
    it('has correct positioning classes', () => {
      const { container } = render(
        <ToastContainer toasts={[{ id: '1', type: 'info', title: 'Test' }]} onClose={vi.fn()} />
      );
