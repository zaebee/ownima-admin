  ...
  return (
    <Card className="md:col-span-2 flex flex-col bg-slate-50 dark:bg-slate-900 border-none relative overflow-hidden">
      ...
      <CardHeader className="pb-2 relative z-10">
        ...
        <CardDescription>{t('exceptionsSub', 'alerts')}</CardDescription>
      </CardHeader>
      <CardContent className="flex-1 relative z-10 pt-4">
        <ul className="space-y-4">
          <li className="flex items-center justify-between border-b border-border/50 pb-3">
            <span className="text-sm font-medium text-slate-700 dark:text-slate-200">{t('overdueReservations', 'alerts')}</span>
          ...
          <li className="flex items-center justify-between border-b border-border/50 pb-3">
            <span className="text-sm font-medium text-slate-700 dark:text-slate-200">{t('bookingConflicts', 'alerts')}</span>
          ...
          <li className="flex items-center justify-between border-b border-border/50 pb-3">
            <span className="text-sm font-medium text-slate-700 dark:text-slate-200">{t('noResponses', 'alerts')}</span>
          ...
          <li className="flex items-center justify-between pb-1">
            <span className="text-sm font-medium text-slate-700 dark:text-slate-200">{t('authFailures', 'alerts')}</span>
